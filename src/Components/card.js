                ...
                <div className="card">
                    <div className="card-body row">
                        ...
                        <div className="col-7">
                            ...
                            <h6 className="text-dark">Harga : {this.props.harga}</h6>
                            ...
                            <button className="btn btn-sm btn-success m-1" onClick={this.props.onCart}>Tambah Ke Keranjang Belanja</button>
                        </div>
                    </div>
                </div>
            </div>
